        ...
        <div className="space-y-0">
          {notes.map((note) => (
            ...
            >
              ...
              {/* オーバーレイ表示 */}
              <div className="absolute left-0 right-0 top-full mt-4 opacity-0 invisible peer-hover:opacity-100 peer-hover:visible transition-all duration-200 z-10 bg-[#1a1a1a] border border-terminal-text/20 rounded p-3 shadow-lg pointer-events-none">
                {note.excerpt && (
